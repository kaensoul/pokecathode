...
TreeMonMaps: ; b825e
	...
	treemon_map ROUTE_37,                  TREEMON_SET_CITY
	...
	treemon_map ROUTE_42,                  TREEMON_SET_KANTO
	treemon_map ROUTE_43,                  TREEMON_SET_LAKE
	treemon_map ROUTE_44,                  TREEMON_SET_LAKE
...
RockMonMaps: ; b82c5
	...
	treemon_map UNION_CAVE_B1F,            TREEMON_SET_ROCK
	db -1
; b82d2
