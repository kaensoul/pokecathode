...
; entries correspond to FRUITTREE_* constants
	...
	db GOLD_BERRY   ; ROUTE_37_1
	db MYSTERYBERRY ; ROUTE_37_2
	db MIRACLEBERRY ; ROUTE_37_3
	db GOLD_BERRY   ; AZALEA_TOWN
	db MIRACLEBERRY ; ROUTE_42_1
	db GOLD_BERRY   ; ROUTE_42_2
	db MYSTERYBERRY ; ROUTE_42_3
	db BERRY        ; ROUTE_11
