...
MapGroup_Dungeons:
	...
	map NationalPark, TILESET_JOHTO_MODERN, ROUTE, NATIONAL_PARK, MUSIC_NATIONAL_PARK, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map UnionCaveB1F, TILESET_CAVE, CAVE, UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_DARK, FISHGROUP_LAKE
	map UnionCaveB2F, TILESET_ICE_PATH, CAVE, UNION_CAVE, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map IlexForest, TILESET_FOREST, CAVE, ILEX_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_LAKE
...
MapGroup_Blackthorn:
	map BlackthornGym1F, TILESET_PORT, INDOOR, BLACKTHORN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BlackthornGym2F, TILESET_PLAYERS_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map VioletCity, TILESET_KANTO, TOWN, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_NewBark:
	...
	map Route29, TILESET_JOHTO, ROUTE, ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
    ...
    map PebbleMart, TILESET_MART, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PebbleGym, TILESET_LAB, INDOOR, NEW_BARK_TOWN, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
