...
; entries correspond to constants/pokemon_constants.asm
	mon_cry CRY_BULBASAUR,   $0B0,  $07B ; BULBASAUR
	mon_cry CRY_BULBASAUR,   $040,  $100 ; IVYSAUR
	mon_cry CRY_BULBASAUR,   $006,  $183 ; VENUSAUR
	mon_cry CRY_CHARMANDER,  $074,  $095 ; CHARMANDER
	mon_cry CRY_CHARMANDER,  $028,  $0c5 ; CHARMELEON
	mon_cry CRY_CHARMANDER,  $001,  $1F5 ; CHARIZARD
	mon_cry CRY_SQUIRTLE,    $028,  $0B0 ; SQUIRTLE
	mon_cry CRY_SQUIRTLE,    $055,  $0B0 ; WARTORTLE
	mon_cry CRY_BLASTOISE,   $0F2,  $1A0 ; BLASTOISE
	mon_cry CRY_CATERPIE,    $093,  $0a0 ; CATERPIE
	mon_cry CRY_CATERPIE,    $0A8,  $0E1 ; METAPOD
	mon_cry CRY_CATERPIE,    $067,  $0FD ; BUTTERFREE
	mon_cry CRY_WEEDLE,      $036,  $081 ; WEEDLE
	mon_cry CRY_BLASTOISE,   $032,  $0E1 ; KAKUNA
	mon_cry CRY_BLASTOISE,   $091,  $100 ; BEEDRILL
	mon_cry CRY_PIDGEY,      $021,  $0E7 ; PIDGEY
	mon_cry CRY_PIDGEOTTO,   $03A,  $152 ; PIDGEOTTO
	mon_cry CRY_PIDGEOTTO,   $072,  $1C0 ; PIDGEOT
	mon_cry CRY_RATTATA,     $0A8,  $1E0 ; RATTATA
	mon_cry CRY_RATTATA,     $075,  $17f ; RATICATE
	mon_cry CRY_SPEAROW,     $0E2,  $1E1 ; SPEAROW
	mon_cry CRY_EKANS,       $075,  $0F0 ; EKANS
	mon_cry CRY_FEAROW,      $0AF,  $101 ; FEAROW
	mon_cry CRY_EKANS,       $012,  $040 ; ARBOK
	mon_cry CRY_BLASTOISE,   $0ee,  $081 ; PIKACHU
	mon_cry CRY_NIDORAN_F,   $031,  $0E1 ; RAICHU
	mon_cry CRY_NIDORAN_F,   $020,  $0c0 ; SANDSHREW
	mon_cry CRY_NIDORAN_M,   $040,  $105 ; SANDSLASH
	mon_cry CRY_BLASTOISE,   $000,  $100 ; NIDORAN_F
	mon_cry CRY_NIDORAN_F,   $05E,  $161 ; NIDORINA
	mon_cry CRY_NIDORAN_F,   $000,  $100 ; NIDOQUEEN
	mon_cry CRY_NIDORAN_M,   $080,  $160 ; NIDORAN_M
	mon_cry CRY_PARAS,       $02c,  $140 ; NIDORINO
	mon_cry CRY_RAICHU,      $021,  $180 ; NIDOKING
	mon_cry CRY_MAGCARGO,    $0a1,  $0e8 ; CLEFAIRY
	mon_cry CRY_MAGCARGO,    $0aa,  $0a0 ; CLEFABLE
	mon_cry CRY_GOLEM,       $04f,  $090 ; VULPIX
	mon_cry CRY_SUNFLORA,    $088,  $0e0 ; NINETALES
	mon_cry CRY_RAICHU,      $0ff,  $0b5 ; JIGGLYPUFF
	mon_cry CRY_RAICHU,      $088,  $0e0 ; WIGGLYTUFF
	mon_cry CRY_NIDOQUEEN,   $0e0,  $100 ; ZUBAT
	mon_cry CRY_BLASTOISE,   $0fa,  $100 ; GOLBAT
	mon_cry CRY_SPEAROW,     $0dd,  $081 ; ODDISH
	mon_cry CRY_FEAROW,      $0aa,  $0c0 ; GLOOM
	mon_cry CRY_CLEFFA,      $022,  $17f ; VILEPLUME
	mon_cry CRY_FEAROW,      $020,  $160 ; PARAS
	mon_cry CRY_PIDGEY,      $042,  $17f ; PARASECT
	mon_cry CRY_SPEAROW,     $044,  $0c0 ; VENONAT
	mon_cry CRY_FEAROW,      $029,  $100 ; VENOMOTH
	mon_cry CRY_GROWLITHE,   $0aa,  $081 ; DIGLETT
	mon_cry CRY_BLASTOISE,   $02a,  $090 ; DUGTRIO
	mon_cry CRY_HOOTHOOT,    $077,  $090 ; MEOWTH
	mon_cry CRY_PSYDUCK,     $099,  $17f ; PERSIAN
	mon_cry CRY_LEDYBA,      $020,  $0e0 ; PSYDUCK
	mon_cry CRY_MARILL,      $0ff,  $0c0 ; GOLDUCK
	mon_cry CRY_WEEPINBELL,  $0dd,  $0e0 ; MANKEY
	mon_cry CRY_PSYDUCK,     $0af,  $0c0 ; PRIMEAPE
	mon_cry CRY_PSYDUCK,     $020,  $0c0 ; GROWLITHE
	mon_cry CRY_PSYDUCK,     $000,  $100 ; ARCANINE
	mon_cry CRY_PIDGEY,      $0ff,  $17f ; POLIWAG
	mon_cry CRY_BLASTOISE,   $077,  $0e0 ; POLIWHIRL
	mon_cry CRY_AIPOM,       $000,  $17f ; POLIWRATH
	mon_cry CRY_VULPIX,      $0c0,  $081 ; ABRA
	mon_cry CRY_CHARMANDER,  $0a8,  $140 ; KADABRA
	mon_cry CRY_GOLEM,       $098,  $17f ; ALAKAZAM
	mon_cry CRY_GROWLITHE,   $0ee,  $081 ; MACHOP
	mon_cry CRY_BLASTOISE,   $048,  $0e0 ; MACHOKE
	mon_cry CRY_BULBASAUR,   $008,  $140 ; MACHAMP
	mon_cry CRY_RAIKOU,      $055,  $081 ; BELLSPROUT
	mon_cry CRY_RAIKOU,      $044,  $0a0 ; WEEPINBELL
	mon_cry CRY_GOLEM,       $066,  $14c ; VICTREEBEL
	mon_cry CRY_DROWZEE,     $000,  $100 ; TENTACOOL
	mon_cry CRY_VENONAT,     $0ee,  $17f ; TENTACRUEL
	mon_cry CRY_CLEFAIRY,    $0f0,  $090 ; GEODUDE
	mon_cry CRY_CLEFAIRY,    $000,  $100 ; GRAVELER
	mon_cry CRY_WEEDLE,      $0e0,  $0c0 ; GOLEM
	mon_cry CRY_AMPHAROS,    $000,  $100 ; PONYTA
	mon_cry CRY_CATERPIE,    $020,  $140 ; RAPIDASH
	mon_cry CRY_PARAS,       $000,  $100 ; SLOWPOKE
	mon_cry CRY_BULBASAUR,   $000,  $100 ; SLOWBRO
	mon_cry CRY_KANGASKHAN,  $080,  $0e0 ; MAGNEMITE
	mon_cry CRY_WEEDLE,      $020,  $140 ; MAGNETON
