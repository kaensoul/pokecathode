...
RageDescription:
	db   "The user plays."
	next "rough with the foe.@"

TeleportDescription:
	db   "Move the user to"
	next "a different place.@"
...
ConversionDescription:
	db   "The user generate"
	next "and move a rock.@"
