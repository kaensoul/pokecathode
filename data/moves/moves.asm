...
; entries correspond to constants/move_constants.asm
	...
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          30, FIGHTING, PHYSICAL, 100, 15,   0
	move MEGA_PUNCH,   EFFECT_LEECH_HIT,          75, FIGHTING, PHYSICAL, 100, 10,   0
	...
	move SCRATCH,      EFFECT_POISON_MULTI_HIT,   55, POISON,   PHYSICAL, 100, 35,  20
	move VICEGRIP,     EFFECT_FLINCH_HIT,         85, STEEL,    PHYSICAL,  80, 10,  10
	move GUILLOTINE,   EFFECT_NORMAL_HIT,         95, GHOST,    PHYSICAL, 100, 20,   0
	move RAZOR_WIND,   EFFECT_CONFUSE_HIT,       120, FLYING,   SPECIAL,   70, 10,  30
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,   STATUS,   100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         70, STEEL,    PHYSICAL, 100, 30,   0
	...
	move BIND,         EFFECT_TRAP_TARGET,        80, GRASS,    PHYSICAL,  75, 20,   0
	...
	move MEGA_KICK,    EFFECT_ATTACK_UP_HIT,      90, FIGHTING, PHYSICAL,  90,  5, 100
	move JUMP_KICK,    EFFECT_JUMP_KICK,          70, FIGHTING, PHYSICAL,  95, 25,   0
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         90, FIGHTING, SPECIAL,  100, 15,  20
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,   STATUS,   100, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         80, NORMAL,   PHYSICAL, 100, 15,  30
	...
	move HORN_DRILL,   EFFECT_LEECH_HIT,          75, GRASS,    PHYSICAL, 100, 10,   0
	...
	move SONICBOOM,    EFFECT_FLINCH_HIT,         75, FLYING,   SPECIAL,   95, 15,  30
	...
	move SUBMISSION,   EFFECT_CONFUSE_HIT,        90, PSYCHIC,  PHYSICAL, 100, 25,  10
	...
	move FISSURE,      EFFECT_SP_DEF_DOWN_HIT,    90, GROUND,   SPECIAL,  100, 10,  10
	...
	move RAGE,         EFFECT_ATTACK_DOWN_HIT,    90, FAIRY,    PHYSICAL,  90, 10,  10
	move TELEPORT,     EFFECT_PRIORITY_HIT,       40, FAIRY,    PHYSICAL, 100, 20,   0
	move NIGHT_SHADE,  EFFECT_LEVEL_DAMAGE,        1, GHOST,    SPECIAL,  100, 15,   0
	move MIMIC,        EFFECT_MIMIC,               0, NORMAL,   STATUS,   100, 10,   0
	move SCREECH,      EFFECT_CONFUSE_HIT,       100, DRAGON,   SPECIAL,   90, 20,  10
	...
	move EGG_BOMB,     EFFECT_FREEZE_HIT,        150, ICE,      SPECIAL,  100,  5,  30
	...
	move SKULL_BASH,   EFFECT_SP_DEF_DOWN_HIT,   120, DARK,     SPECIAL,   80, 15,  10
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          35, STEEL,    PHYSICAL, 100, 15,   0
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     35, NORMAL,   PHYSICAL, 100, 35,  10
	...
	move BARRAGE,      EFFECT_FREEZE_HIT,        100, ICE,      PHYSICAL, 100, 10,  10
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,      PHYSICAL, 100, 15,   0
	move LOVELY_KISS,  EFFECT_POISON_HIT,        100, DARK,     SPECIAL,  100, 20,  20
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  60, FAIRY,    SPECIAL,   90, 10,   5
	move PSYWAVE,      EFFECT_SP_DEF_DOWN_HIT,    90, BUG,      SPECIAL,  100, 10,  10
	...
	move HYPER_FANG,   EFFECT_PARALYZE_HIT,      100, ROCK,     PHYSICAL, 100, 15,  10
	move SHARPEN,      EFFECT_NORMAL_HIT,         90, STEEL,    SPECIAL,  100, 20,   0
	move CONVERSION,   EFFECT_FLINCH_HIT,         90, ROCK,     SPECIAL,  100, 20,  10
	...
	move QUIVER_DANCE, EFFECT_CONVERSION2,         0, BUG,      STATUS,   100, 20,   0
	move AEROBLAST,    EFFECT_NORMAL_HIT,        120, NORMAL,   SPECIAL,  100, 10,   0
	...
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         40, ICE,      PHYSICAL,  100, 25,  10
	...
	move SWEET_KISS,   EFFECT_CONFUSE_HIT,        60, FAIRY,    SPECIAL,   90, 10,  10
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  95, WATER,    SPECIAL,   95, 10,  50
	...
	move SPARK,        EFFECT_PARALYZE_HIT,      100, ELECTRIC, PHYSICAL, 100, 10,  10
	...
	move SACRED_FIRE,  EFFECT_NORMAL_HIT,         80, DRAGON,   PHYSICAL, 100, 15,   0
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,    PHYSICAL,  90, 15,  30
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   60, FIGHTING, PHYSICAL, 100, 15, 100
	...
	move LOVE_CANNON,  EFFECT_ATTACK_DOWN_HIT,   120, FAIRY,    SPECIAL,   75,  5,  10
