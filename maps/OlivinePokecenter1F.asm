...
OlivinePokecenter1FFisherText:
	text "Hace unos 50 años"
	line "un meteorito cayó"
	cont "en esta ciudad,"

	para "aunque era real-"
	line "mente pequeño,"
	cont "el daño que causo"
	cont "fue enorme."
	done

OlivinePokecenter1FTeacherText:
	text "Nunca envejecer"
	line "debe ser genial,"
	cont "pero si tengo que"

	para "ver a todos los"
	line "que conozco morir,"
	cont "entonces mejor no."
	done
...
OlivinePokecenter1F_MapEvents:
	...
	object_event  8,  4, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePokecenter1FFishingGuruScript, -1
